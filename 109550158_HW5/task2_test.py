...
class Task2Dataset(Dataset):
    def __init__(self, data, root, transforms, return_filename=False):
        self.data = [
            sample for sample in data if sample[0].startswith("task2")]
...
if __name__ == '__main__':
    ...
    test_ds = Task2Dataset(test_data, root=TEST_PATH,
                           return_filename=True, transforms=data_transforms)
